...
type BedTypeFormValues = { name: string; capacity: number | null };

interface AddBedTypeProps {
  open?: boolean;
...
const AddBedType: React.FC<AddBedTypeProps> = ({ open, onOpenChange, form, validationErrors }) => {

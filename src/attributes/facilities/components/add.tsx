...
type FacilityFormValues = { name: string; icon: string };

interface AddFacilityProps {
  open: boolean;
  onOpenChange?: (open: boolean) => void;
  form: ReactFormExtendedApi<FacilityFormValues, any, any, any, any, any, any, any, any, any, any, any>;
  validationErrors?: Record<string, string[]>
}

const AddFacility: React.FC<AddFacilityProps> = ({ open, onOpenChange, form, validationErrors }) => {
